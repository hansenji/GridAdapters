...
import net.vikingsen.gridadapters.GroupGridListAdapter;
 ...
 */
public class SampleGroupGridListAdapter extends GroupGridListAdapter<Distro> implements View.OnClickListener {

    private final LayoutInflater inflater;

    private OnItemClickListener onItemClickListener;

    public SampleGroupGridListAdapter(Context context) {
    ...
    public static interface OnItemClickListener {
        void onItemClick(SampleGroupGridListAdapter adapter, View view, int position);
    }
}
